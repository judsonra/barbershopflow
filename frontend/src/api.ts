import type { AdminCustomerMatch, Appointment, Customer, ImpersonationAuditEntry, MembershipOption, Professional, Report, ScheduleEntry, Service, Tenant, TimeOff, User } from './types'
...
export const api = {
  ...
  listImpersonationAudit: () => request<ImpersonationAuditEntry[]>('/admin/audit'),
